<!-- components/course/CourseListItem.vue - Progress Number 타입 지원 버전 -->
<template>
  <el-card
    ...
    <div class="course-content">
      ...
      <div class="course-meta">
        ...
        <div v-if="supportedLanguages.length > 1" class="language-info">
          <div class="meta-divider">•</div>
          <el-icon size="14" color="#67c23a"><ChatDotSquare /></el-icon>
      ...
      <div v-if="course.flaskData" class="flask-meta">
        <div class="flask-info">
          <el-icon size="12" color="#909399"><Collection /></el-icon>
...
interface Props {
  ...
  progress?: CourseProgress | number | null
...
interface Emits {
  ...
  (e: 'select', course: Course, selected: boolean): void
  (e: 'enroll', course: Course): void
  (e: 'continue', course: Course): void
  (e: 'start', course: Course): void
  (e: 'review', course: Course): void
  (e: 'qr-access', course: Course): void
  (e: 'bookmark', course: Course, bookmarked: boolean): void
}
...
const isNewCourse = computed(() => {
  ...
  return props.course.createdAt > weekAgo
})
...
// 카테고리 표시 텍스트
const getCategoryDisplayText = (category?: { main?: string; middle?: string; leaf?: string }) => {
